<div class="relative">
    <button class="peer flex flex-row items-center gap-2">
        {{ auth()->user()->name }}
        <span
            class="h-0 w-0 border-l-[5px] border-r-[5px] border-t-[10px] border-l-transparent border-r-transparent border-t-black"></span>
    </button>
    <div
